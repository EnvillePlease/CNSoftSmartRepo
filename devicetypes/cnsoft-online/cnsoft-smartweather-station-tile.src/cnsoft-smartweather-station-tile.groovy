 ...
 *
 *  Author: SmartThings & Clark Nelson
 *
 *  Date: 2013-04-30
 *  Date 2019-05-17 Modified to add corrected illuminance calculation for midlands UK
 */
metadata {
    definition (name: "CNSoft SmartWeather Station Tile", namespace: "CNSoft OnLine", author: "Clark Nelson & SmartThings") {
    ...
    tiles(scale: 2) {
        valueTile("temperature", "device.temperature", height: 6, width: 6) {
            state "default", icon: 'device.weatherUrl', label:'${currentValue}°',
                    backgroundColors:[
...
def pollUsingZipCode(String zipCode) {
    ...
    if (obs) {
        ...
        send(name: "weatherUrl", value: getForecastIcon(obs.iconCode) as String, displayed: false)
        ...
        if (alerts) {
            ...
            send(name: "alert", value: "No current alerts " + getForecastIcon(obs.iconCode), descriptionText: msg)
        }
    }
    else {
...
private getForecastIcon(iconstate) {

	def returnurl = ""
    
    switch (iconstate) {
    	case "00" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/00.png"
			break
		case "01" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/01.png"
			break
		case "02" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/02.png"
			break
		case "03" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/03.png"
			break
		case "04" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/04.png"
			break
		case "05" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/05.png"
			break
		case "06" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/06.png"
			break
		case "07" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/07.png"
			break
		case "08" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/08.png"
			break
		case "09" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/09.png"
			break
		case "10" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/10.png"
			break
		case "11" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/11.png"
			break
		case "12" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/12.png"
			break
		case "13" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/13.png"
			break
		case "14" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/14.png"
			break
		case "15" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/15.png"
			break
		case "16" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/16.png"
			break
		case "17" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/17.png"
			break
		case "18" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/18.png"
			break
		case "19" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/19.png"
			break
		case "20" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/20.png"
			break
		case "21" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/21.png"
			break
		case "22" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/22.png"
			break
		case "23" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/23.png"
			break
		case "24" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/24.png"
			break
		case "25" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/25.png"
			break
		case "26" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/26.png"
			break
		case "27" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/27.png"
			break
		case "28" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/28.png"
			break
		case "29" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/29.png"
			break
		case "30" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/30.png"
			break
		case "31" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/31.png"
			break
		case "32" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/32.png"
			break
		case "33" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/33.png"
			break
		case "34" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/34.png"
			break
		case "35" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/35.png"
			break
		case "36" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/36.png"
			break
		case "37" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/37.png"
			break
		case "38" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/38.png"
			break
		case "39" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/39.png"
			break
		case "40" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/40.png"
			break
		case "41" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/41.png"
			break
		case "42" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/42.png"
			break
		case "43" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/43.png"
			break
		case "44" :
			returnURL = "https://smartthings-twc-icons.s3.amazonaws.com/44.png"
			break
		case "45" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/45.png"
			break
		case "46" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/46.png"
			break
		case "47" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/47.png"
			break
		case "na" :
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/na.png"
			break
		default:
			returnurl = "https://smartthings-twc-icons.s3.amazonaws.com/na.png"
    }
