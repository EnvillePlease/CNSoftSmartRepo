...
metadata {
definition (name: "Yale Contact Sensor", namespace: "CNSoft OnLine", author: "Clark Nelson") {
...
// Sets up the automatic refresh of the contact sensor
def installed() {
	updated()
}
